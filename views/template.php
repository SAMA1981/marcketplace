...
if(!empty($_SERVER['HTTPS']) && ('on' == $_SERVER['HTTPS'])){
	...
	if(!empty(array_filter($routesArray)[3])){
...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=Acx78D33NHxRsU3WuggHMIuAPFc8wDOrojfoPycksadg-N1vUmzpwYE5P7mdHkgXv8cLQo_PHm5DhQrC"></script>
